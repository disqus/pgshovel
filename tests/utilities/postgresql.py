...
def test_pg_date_format():
    assert pg_date_format(datetime(2015, 3, 23, 16, 15, 1, 898802)) == '2015-03-23 16:15:01.898802'
    assert pg_date_format(datetime(2015, 3, 23, 16, 15, 1, 898802, utc)) == '2015-03-23 16:15:01.898802+00'
    assert pg_date_format(datetime(2015, 3, 23, 16, 15, 1, 890000, utc)) == '2015-03-23 16:15:01.89+00'
    assert pg_date_format(datetime(2015, 3, 23, 16, 15, 1, 898802, FixedOffsetTimezone(-8 * 60, 'PST'))) == '2015-03-23 16:15:01.898802-08'

    # Australia is weird: http://en.wikipedia.org/wiki/UTC%2B09:45
    assert pg_date_format(datetime(2015, 3, 23, 16, 15, 1, 0, FixedOffsetTimezone(9 * 60 + 45, 'UTC+09:45'))) == '2015-03-23 16:15:01+09:45'
